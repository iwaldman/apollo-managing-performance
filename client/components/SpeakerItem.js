  ...
  return (
    <div className="favbox" key={id}>
      <div className="fav-clm col-sm-7">
        <span
          className={checkBoxColumn === true ? 'fa fa-check-square-o' : 'fa fa-square-o'}
          onClick={() => {
            checkBoxListVar(
              checkBoxColumn === true
      ...
      <div className="fav-clm col-sm-5">
        <div className="action">
          ...
          >
            <div className={favorite === true ? 'fa fa-star orange' : 'fa fa-star-o orange'} />
            &nbsp;&nbsp; Favorite
          </span>
          <span
            onClick={() => {
                  ...
                  cache.writeQuery({
                    ...
                    data: {
                      speakers: {
                        ...
                        datalist: speakers.datalist.filter((rec) => rec.id != deleteSpeaker.id),
                      },
                    },
                  })
                },
